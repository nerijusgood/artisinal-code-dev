...
export function HomeExhibitionLab() {
                ...
                <div className="mt-6 grid gap-5 lg:grid-cols-[18rem_minmax(0,1fr)]">
                  ...
                  <div className="code-panel p-5">
                    ...
                    <pre className="mt-4 overflow-x-auto font-mono text-sm leading-7 text-[#f5ecdc]">
                      <code>{currentSpecimen.artifact}</code>
                    </pre>
                  </div>
                </div>
              </section>
              ...
              <section className="museum-panel p-6">
                ...
                {legacyUnlocked ? (
                  <div className="legacy-warning mt-5 p-5">
                    ...
                    <div className="code-panel mt-5 p-4">
                      <p className="font-mono text-[10px] uppercase tracking-[0.3em] text-[#d6c4ad]">
                        Restricted system fragment
                      </p>
                      <pre className="mt-3 overflow-x-auto font-mono text-xs leading-6 text-[#f5ecdc]">
                        <code>{`// DO NOT TOUCH\nif (legacyMode) return runOldFlow(payload);`}</code>
                      </pre>
                    </div>
                  </div>
                ) : (
